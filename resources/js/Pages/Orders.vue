...
const filteredOrders = computed(() => {
    return props.orders
        .filter(order =>
            (!searchQuery.value || order.name.toLowerCase().includes(searchQuery.value.toLowerCase())) &&
                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800 w-full"
                    ...
                    <div
                        ...
                        <input v-model="searchQuery" type="text" placeholder="Search by name..."
                            class="mt-0 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-indigo-600 dark:focus:ring-indigo-600 block w-full md:w-1/2" />
                        ...
                        <button @click="clearFilters()"
                            class="inline-flex items-center rounded-md border border-transparent bg-gray-800 px-4 py-1 text-xs font-semibold uppercase tracking-widest text-white transition duration-150 ease-in-out hover:bg-gray-700 focus:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 active:bg-gray-900 dark:bg-gray-200 dark:text-gray-800 dark:hover:bg-white dark:focus:bg-white dark:focus:ring-offset-gray-800 dark:active:bg-gray-300">
                            Clear
                        </button>
                    </div>
                    ...
                    <div class="p-6 text-gray-900 dark:text-gray-100 ">
                        ...
                        <ul>
                            <li v-for="order in filteredOrders" :key="order.id" :class="{
